...
const serviceDetails: Record<string, any> = {
  'physical-guarding': {
    ...
    icon: Shield,
    img: 'https://picsum.photos/seed/guard/1200/600',
  ...
  'corporate-consulting': {
    ...
    icon: Award,
    img: 'https://picsum.photos/seed/consult/1200/600',
  ...
  'command-centre': {
    ...
    icon: Microscope,
    img: 'https://picsum.photos/seed/command/1200/600',
  ...
  'integrated-facility': {
    ...
    icon: Users,
    img: 'https://picsum.photos/seed/facility/1200/600',
  ...
  'cyber-security': {
    ...
    icon: Zap,
    img: 'https://picsum.photos/seed/cyber/1200/600',
  ...
  'electronic-security': {
    ...
    icon: BookOpen,
    img: 'https://picsum.photos/seed/electronic/1200/600',
