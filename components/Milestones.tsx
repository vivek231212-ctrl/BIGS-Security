    ...
    <section className="py-[7.5px] bg-white text-black">
      <div className="container mx-auto px-6">
        <div className="text-center mb-24">
          ...
          <h2 className="text-5xl font-black uppercase tracking-tight">Facts & Milestones</h2>
        </div>

        <div className="max-w-6xl mx-auto">
          {milestones.map((item, i) => (
            <div key={i} className="flex gap-12 md:gap-24 mb-20 last:mb-0 relative group">
              <div className="hidden md:flex flex-col items-end w-1/4 pt-1">
                <span className="text-5xl font-black text-black/10 group-hover:text-[#e63946] transition-colors">{item.year}</span>
              </div>
              
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full border-8 border-white bg-black group-hover:bg-[#e63946] transition-all z-10 shadow-xl" />
                <div className="w-1 h-full bg-slate-100 absolute top-10" />
              </div>
              
              <div className="flex-1 pb-10">
                <span className="md:hidden text-2xl font-black text-[#e63946] block mb-2">{item.year}</span>
