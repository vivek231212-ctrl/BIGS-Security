...
import { Facebook, Twitter, Linkedin, Instagram, ArrowUp, Download, Loader2, Code2, Globe, FileCode } from 'lucide-react';
...
<head>
    ...
    <title>BIGS Support Services | Corporate Security & Integrated Facilities</title>
...
<body class="antialiased">
    ...
    <header class="fixed w-full z-50 transition-all duration-500 bg-transparent py-8 text-white">
        <div class="container mx-auto px-8 flex justify-between items-center">
            ...
            <button id="mobile-menu-btn" class="lg:hidden p-2"><i data-lucide="menu" class="w-8 h-8"></i></button>
        </div>
    </header>
    ...
    <section class="relative min-h-screen flex items-center overflow-hidden bg-black">
        ...
        <div class="container mx-auto px-8 relative z-10">
            <div class="max-w-4xl">
                ...
                <h1 class="text-white text-6xl md:text-8xl font-black uppercase tracking-tighter leading-[0.95] mb-10">
                ...
                <p class="text-white/80 text-xl md:text-2xl max-w-2xl mb-12 font-medium leading-relaxed">
                    World-class security guarding and facility management solutions for India's leading enterprises and critical infrastructure.
                </p>
    ...
    <!-- Stats -->
    <section class="py-20 bg-[#F5F5F5] border-y border-slate-100">
        <div class="container mx-auto px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-white p-12 text-center stat-card transition-all group">
    ...
    <section id="services" class="py-32 bg-white">
        <div class="container mx-auto px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                ...
                <a href="#contact" class="font-black uppercase tracking-widest text-xs border-b-4 border-bigs-red pb-2 hover:text-bigs-red transition-colors flex items-center gap-2 group">
                    All Services <i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                </a>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="group p-12 bg-[#F5F5F5] service-card transition-all border border-slate-100">
                    <div class="w-16 h-16 bg-black text-white group-hover:bg-bigs-red flex items-center justify-center mb-8 transition-colors"><i data-lucide="shield" class="w-8 h-8"></i></div>
                    <h3 class="text-2xl font-black uppercase mb-4">Manpower Guarding</h3>
                    <p class="text-black/50 font-medium mb-8">Elite SIA-compliant personnel trained in high-stakes defensive tactics and risk mitigation.</p>
                ...
                <div class="group p-12 bg-[#F5F5F5] service-card transition-all border border-slate-100">
                    <div class="w-16 h-16 bg-black text-white group-hover:bg-bigs-red flex items-center justify-center mb-8 transition-colors"><i data-lucide="cctv" class="w-8 h-8"></i></div>
                    <h3 class="text-2xl font-black uppercase mb-4">Tech Surveillance</h3>
                    <p class="text-black/50 font-medium mb-8">AI-driven monitoring systems and centralized command solutions for 360° awareness.</p>
                    <span class="text-bigs-red font-black uppercase text-[10px] tracking-widest group-hover:pl-4 transition-all flex items-center gap-2">Read More <i data-lucide="arrow-right" class="w-3 h-3"></i></span>
                </div>
                <div class="group p-12 bg-[#F5F5F5] service-card transition-all border border-slate-100">
                    <div class="w-16 h-16 bg-black text-white group-hover:bg-bigs-red flex items-center justify-center mb-8 transition-colors"><i data-lucide="building-2" class="w-8 h-8"></i></div>
                    <h3 class="text-2xl font-black uppercase mb-4">Facility Mgmt</h3>
                    <p class="text-black/50 font-medium mb-8">Comprehensive maintenance, housekeeping and soft services for premium infrastructure.</p>
                    <span class="text-bigs-red font-black uppercase text-[10px] tracking-widest group-hover:pl-4 transition-all flex items-center gap-2">Read More <i data-lucide="arrow-right" class="w-3 h-3"></i></span>
                </div>
            </div>
        </div>
    ...
    <section class="py-32 bg-[#0A0A0A] text-white">
        <div class="container mx-auto px-8">
            <div class="text-center mb-24">
                <span class="text-bigs-red font-black tracking-[0.4em] uppercase text-xs mb-4 block">Market Segments</span>
                <h2 class="text-5xl lg:text-7xl font-black uppercase tracking-tighter">Sector Expertise</h2>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="relative h-96 overflow-hidden industry-card cursor-pointer">
                    <img src="https://picsum.photos/seed/bank/800/800" class="w-full h-full object-cover grayscale transition-slow" alt="Banking">
                    <div class="absolute inset-0 overlay"></div>
                    <div class="absolute bottom-10 left-10"><h3 class="text-3xl font-black uppercase tracking-tight">Banking & BFSI</h3><div class="h-1 w-12 bg-bigs-red mt-4 transition-all group-hover:w-full"></div></div>
                </div>
                <div class="relative h-96 overflow-hidden industry-card cursor-pointer">
                    <img src="https://picsum.photos/seed/retail/800/800" class="w-full h-full object-cover grayscale transition-slow" alt="Retail">
                    <div class="absolute inset-0 overlay"></div>
                    <div class="absolute bottom-10 left-10"><h3 class="text-3xl font-black uppercase tracking-tight">Retail Chains</h3><div class="h-1 w-12 bg-bigs-red mt-4 transition-all group-hover:w-full"></div></div>
                </div>
                <div class="relative h-96 overflow-hidden industry-card cursor-pointer">
                    <img src="https://picsum.photos/seed/health/800/800" class="w-full h-full object-cover grayscale transition-slow" alt="Healthcare">
                    <div class="absolute inset-0 overlay"></div>
                    <div class="absolute bottom-10 left-10"><h3 class="text-3xl font-black uppercase tracking-tight">Healthcare</h3><div class="h-1 w-12 bg-bigs-red mt-4 transition-all group-hover:w-full"></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer id="contact" class="bg-bigs-red text-white pt-32 pb-16 relative border-t-8 border-black">
        <div class="container mx-auto px-8">
            <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-20 mb-20">
                <div>
                    <div class="flex items-center gap-3 mb-10">
                        <img src="https://bigs.in/lobo.jpeg" class="h-12 bg-white p-1 rounded">
                        <h1 class="font-black text-2xl uppercase tracking-tighter">BIGS</h1>
                    </div>
                    <p class="text-white/80 font-medium mb-10 leading-relaxed">Protecting progress through excellence since 1998. India's most trusted integrated force.</p>
                    <div class="flex gap-4">
                        <a href="#" class="w-12 h-12 bg-black flex items-center justify-center rounded hover:bg-white hover:text-black transition-all"><i data-lucide="facebook" class="w-5 h-5"></i></a>
                        <a href="#" class="w-12 h-12 bg-black flex items-center justify-center rounded hover:bg-white hover:text-black transition-all"><i data-lucide="linkedin" class="w-5 h-5"></i></a>
                    </div>
                </div>
                <div>
                    <h4 class="text-black font-black uppercase tracking-widest text-xs mb-10">Headquarters</h4>
                    <p class="text-white font-bold text-sm leading-relaxed">102, Western Plaza,<br>Udhna Main Road, Surat,<br>Gujarat, India - 394210</p>
                </div>
                <div>
                    ...
                    <ul class="space-y-4 font-black text-[10px] uppercase tracking-widest">
                        <li><a href="#" class="hover:text-black">Guarding</a></li>
            ...
            <div class="border-t border-white/20 pt-10 text-center"><p class="text-[10px] font-black uppercase tracking-widest text-white/50">© 2024 BIGS Support Services Pvt. Ltd.</p></div>
        </div>
    </footer>
    <script src="js/main.js"></script>
      ...
      link.href = url;
      link.download = `BIGS_Home_${type.toUpperCase()}.zip`;
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            <div className="bg-black/20 p-6 rounded-2xl mb-10 border border-white/10">
               ...
               <p className="text-[8px] font-bold text-black/50 mt-3 text-center uppercase tracking-widest">Standard Elementor-style Output</p>
            </div>
